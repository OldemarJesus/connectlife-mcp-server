...
5. Update `README.md` tool table, `ARCH.md` §2.4 tools table, and the relevant `PRD.md` §4 functional requirements if product scope changes. Use the `update-docs` skill to stay consistent.
